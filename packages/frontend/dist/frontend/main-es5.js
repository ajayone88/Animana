(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(cdRef, sharedService) {
                    this.cdRef = cdRef;
                ...
                AppComponent.prototype.ngAfterViewChecked = function () {
                    var _this = this;
                    this.sharedService.error.subscribe(function (error) {
                        _this.showError = error.showError;
                        _this.error = {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClientComponent = /** @class */ (function () {
                function ClientComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                    this.object = Object;
                ...
                ClientComponent.prototype.fetchClients = function () {
                    var _this = this;
                    this.sharedService.closeError();
                    this.sharedService.getClients().subscribe(function (clients) {
                        _this.client = clients['clients'].filter(function (val) {
                            return +val.id === _this.clientId;
                        });
                        _this.client = _this.client[0];
                    }, function (error) {
                        var err = {
                            heading: 'Error',
                            description: 'Client service failed'
                        };
                        _this.sharedService.openError(err);
                    });
                };
                ClientComponent.prototype.fetchPatients = function () {
                    var _this = this;
                    this.sharedService.closeError();
                    this.sharedService.getPatientsForClient().subscribe(function (patients) {
                        _this.patients = patients['patients'];
                        _this.patients = _this.patients.filter(function (val) {
                            return +val.clientId === _this.clientId;
                        });
                    }, function (error) {
                        var err = {
                            heading: 'Error',
                ...
                ClientComponent.prototype.fetchInvoice = function () {
                    var _this = this;
                    this.sharedService.closeError();
                    this.sharedService.getInvoicesForClient().subscribe(function (invoices) {
                        _this.invoices = invoices['invoices'];
                        _this.invoices = _this.invoices.filter(function (val) {
                            return +val.clientId === _this.clientId;
                        });
                    }, function (error) {
                        var err = {
                ...
                ClientComponent.prototype.openPatient = function (id) {
                    this.router.navigate(['patients/patient', id]);
                };
                ClientComponent.prototype.openInvoice = function (id) {
                    this.router.navigate(['invoices/invoice', id]);
                };
                ClientComponent.prototype.navigateBack = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClientsComponent = /** @class */ (function () {
                function ClientsComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                    this.object = Object;
                ...
                ClientsComponent.prototype.ngOnInit = function () {
                    ...
                    this.sharedService.getClients().subscribe(function (clients) {
                        ...
                        _this.maxLength = _this.clients.length;
                        _this.creatPagination(_this.clients, 0);
                    }, function (error) {
                        var err = {
                ...
                ClientsComponent.prototype.creatPagination = function (clients, start) {
                    var _this = this;
                    this.previous = start;
                    if (this.maxLength < this.next) {
                        this.next = this.maxLength - 1;
                    }
                    this.limitedClient = clients.filter(function (value, index) {
                        return index >= start && index <= _this.next;
                    });
                };
                //This function is used to filter out the client based on the search value.
                ClientsComponent.prototype.setFilter = function (event) {
                    var value = event.target.value;
                    this.limitedClient = this.clients.filter(function (val) {
                ...
                ClientsComponent.prototype.setPrevious = function () {
                    this.previous -= 3;
                ...
                ClientsComponent.prototype.setNext = function () {
                    this.previous += 3;
                    this.next += 3;
                    this.creatPagination(this.clients, this.previous);
                };
                //This function is used to route to the client View.
                ClientsComponent.prototype.navigateToClient = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InvoiceComponent = /** @class */ (function () {
                function InvoiceComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                }
                ...
                InvoiceComponent.prototype.getInvoiceDetails = function () {
                    var _this = this;
                    this.sharedService.getInvoicesForClient().subscribe(function (invoices) {
                        _this.invoice = invoices['invoices'].find(function (val) {
                            return val.number = _this.invoiceNumber;
                        });
                        console.log(_this.invoice);
                    });
                };
                //It is used to navigate back to invoices.
                InvoiceComponent.prototype.navigateBack = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InvoicesComponent = /** @class */ (function () {
                function InvoicesComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                    this.previous = 0;
                ...
                InvoicesComponent.prototype.ngOnInit = function () {
                    ...
                    this.sharedService.getInvoicesForClient().subscribe(function (invoices) {
                        _this.invoices = invoices['invoices'];
                        _this.maxLength = _this.invoices.length;
                        _this.creatPagination(_this.invoices, 0);
                    }, function (err) {
                        var error = {
                            heading: 'Error',
                            description: 'Invoice service failed'
                        };
                        _this.sharedService.openError(error);
                    });
                };
                //It is used to filter out the Invoices for pagination
                InvoicesComponent.prototype.creatPagination = function (invoices, start) {
                    var _this = this;
                    this.previous = start;
                    if (this.maxLength < this.next) {
                        this.next = this.maxLength - 1;
                    }
                    this.limitedInvoices = invoices.filter(function (value, index) {
                        return index >= start && index <= _this.next;
                    });
                };
                // It is used to filter out the invoices based on the search value entered.
                InvoicesComponent.prototype.setFilter = function (event) {
                    var value = event.target.value;
                    this.limitedInvoices = this.invoices.filter(function (val) {
                ...
                InvoicesComponent.prototype.setPrevious = function () {
                    this.previous -= 3;
                    if (this.next + 1 !== this.maxLength) {
                        this.next -= 3;
                    }
                ...
                InvoicesComponent.prototype.setNext = function () {
                    this.previous += 3;
                    this.next += 3;
                    this.creatPagination(this.invoices, this.previous);
                };
                //It is used to navigate Invoice view with id.
                InvoicesComponent.prototype.navigateToPatient = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddPatientComponent = /** @class */ (function () {
                function AddPatientComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                }
                AddPatientComponent.prototype.ngOnInit = function () {
                    ...
                    this.sharedService.getClients().subscribe(function (clients) {
                        _this.sharedService.onModified();
                        _this.clients = clients['clients'];
                    }, function (err) {
                        var error = {
                            heading: 'Error',
                ...
                AddPatientComponent.prototype.validateDateOfBirth = function (formDate) {
                    var currentDate = new Date();
                    var selectedDate = new Date(formDate.viewModel);
                ...
                AddPatientComponent.prototype.onSubmit = function (form) {
                    var _this = this;
                    if (form.valid) {
                        var payload = {
                        ...
                        this.sharedService.addPatient(payload).subscribe(function (val) {
                            _this.sharedService.onModified();
                ...
                AddPatientComponent.prototype.navigateBack = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _shared_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared.service */ "./src/app/shared.service.ts");
            var DeletePatientComponent = /** @class */ (function () {
                function DeletePatientComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                }
                DeletePatientComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                DeletePatientComponent.prototype.deletePatient = function () {
                    var _this = this;
                    this.sharedService.closeError();
                    this.sharedService.deletePatient(this.patientId).subscribe(function (val) {
                        _this.sharedService.onModified();
                        _this.router.navigate(['patients']);
                    }, function (err) {
                        var error = {
                ...
                DeletePatientComponent.prototype.navigateBack = function () {
                    this.router.navigate(['patients']);
                };
                return DeletePatientComponent;
            }());
            DeletePatientComponent.ctorParameters = function () { return [
                { type: _shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PatientComponent = /** @class */ (function () {
                function PatientComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                }
                ...
                PatientComponent.prototype.fetchDetails = function () {
                    var _this = this;
                    this.sharedService.getPatientsForClient().subscribe(function (patients) {
                        _this.patient = patients['patients'].find(function (val) {
                            return +val.id === _this.patientId;
                        });
                        console.log(_this.patient);
                    });
                    this.sharedService.getWeightsForPatient().subscribe(function (weights) {
                        _this.weights = weights['weights'].filter(function (val) {
                            return +val.patientId === _this.patientId;
                        });
                    });
                    this.sharedService.getCallsForPatient().subscribe(function (calls) {
                        _this.calls = calls['calls'].filter(function (val) {
                            return +val.patientId === _this.patientId;
                        });
                    });
                    this.sharedService.getProductsForPatient().subscribe(function (products) {
                        _this.products = products['products'].filter(function (val) {
                            return +val.patientId === _this.patientId;
                        });
                    });
                };
                PatientComponent.prototype.navigateBack = function () {
                    this.router.navigate(['patients']);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PatientsComponent = /** @class */ (function () {
                function PatientsComponent(sharedService, router, route) {
                    this.sharedService = sharedService;
                    this.router = router;
                    this.route = route;
                    this.previous = 0;
                ...
                PatientsComponent.prototype.ngOnInit = function () {
                    ...
                    this.sharedService.onValueChange.subscribe(function () {
                        //It is used to get the patients for the client
                        _this.sharedService.getPatientsForClient().subscribe(function (patients) {
                            _this.patients = patients['patients'];
                            _this.maxLength = _this.patients.length;
                            _this.creatPagination(_this.patients, 0);
                        }, function (err) {
                            var error = {
                                heading: 'Error',
                                description: 'Patient service failed'
                ...
                PatientsComponent.prototype.creatPagination = function (patients, start) {
                    var _this = this;
                    this.previous = start;
                    if (this.maxLength < this.next) {
                        this.next = this.maxLength - 1;
                    }
                    this.limitedPatients = patients.filter(function (value, index) {
                        return index >= start && index <= _this.next;
                    });
                };
                // It is used for filter of the value given in the search box.
                PatientsComponent.prototype.setFilter = function (event) {
                    var value = event.target.value;
                    this.limitedPatients = this.patients.filter(function (val) {
                ...
                //It is used to set the previous page.
                PatientsComponent.prototype.setPrevious = function () {
                    this.previous -= 3;
                    if (this.next + 1 !== this.maxLength) {
                        this.next -= 3;
                    }
                ...
                //It is used to set the next page
                PatientsComponent.prototype.setNext = function () {
                    this.previous += 3;
                    this.next += 3;
                    this.creatPagination(this.patients, this.previous);
                };
                //It is used to move to the patient view with the Id.
                PatientsComponent.prototype.navigateToPatient = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SharedService = /** @class */ (function () {
                ...
                SharedService.prototype.closeError = function () {
                    var error = {
                        showError: false,
                        heading: '',
                        description: ''
                ...
                SharedService.prototype.onModified = function () {
